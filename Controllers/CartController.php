...
class CartController
{
    ...
    function add_cart()
    {
        ...
        if (isset($_SESSION['sanpham'][$id])) {
            ...
            $arr['MaSP'] = $data['ProductID'];
            $arr['TenSP'] = $data['ProductName'];
            $arr['DonGia'] = $data['ProductPrice'];
            $arr['SoLuong'] = 1;
            $arr['ThanhTien'] = $data['ProductPrice'];
            $arr['HinhAnh1'] = $data['ProductImage1'];
            $_SESSION['sanpham'][$id] = $arr;
        }
