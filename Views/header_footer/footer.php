                            ...
                            <div class="footer-text">
                                <ul>
                                    <li>
                                        ...
                                        <p>Ngõ 89 Lương Ngọc Quyến, Quang Trung, Thành phố Thái Nguyên, Thái Nguyên.</p>
                                    ...
                                    <li>
                                        ...
                                        <p>tiemcotra@gmail.com</p>
                                        <p>cotra12@ute.udn.vn</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="single-text">
                            ...
                            <div class="footer-menu">
                                <ul>
                                    ...
                                    <li><a href="?act=shop&sp=<?php echo $row['CategoryID']?>"><i
                                                class="mdi mdi-menu-right"></i><?php echo $row['CategoryName']?></a>
                                    </li>
                                    <?php  } ?>
                                </ul>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <p>&copy; CoTra 2023. All Rights Reserved.</p>
                </div>
