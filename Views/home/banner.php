    ...
    <div id="wrapper">
        <div class="slider-wrapper">
            <div id="mainSlider" class="nivoSlider">
                <?php $i=3;  ?>
                <img style="" src="public/img/banners/banner8.jpg" alt="main slider" title="#htmlcaption" />
                    ...
                    <div style="" class="slider-left slider-right">
                        <div class="slide-text animated zoomInUp">
                            <h1>Tiệm ăn cô trà</h3>
                                <hr>
                                <h4>Với các loại mặt hàng như bánh tét, bánh pía Khmer, bánh in và đặc biệt là cá khô
                                    hảo hạng,
                                    Tiệm bánh cô Trà tự hào đem ẩm thực miền Tây chính gốc tới thực khách
                            </h1>
                        </div>
