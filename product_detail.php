                ...
                <div class="col-xs-12">
                    <div class="reviews padding60 margin-top">
                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="tb">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <div><?= $data['Khoi_luong'] ?></div>
                                            </li>
                                            <li>
                                                <span>Kích thước</span>
                                                <div><?= $data['Kich_thuoc'] ?></div>
                                            </li>
                                            <li>
                                                <span>Màu</span>
                                                <div><?= $data['Mau'] ?></div>
                                            ...
                                            <li>
                                                <span>Chất liệu</span>
                                                <div><?= $data['Chat_lieu'] ?></div>
                                            </li>
                                            <li>
                                                <span>Xuất xứ</span>
                                                <div><?= $data['Xuat_xu'] ?></div>
                                            </li>
                                            <li>
                                                <span>Hình dáng</span>
                                                <div><?= $data['Hinh_dang'] ?></div>
                                            </li>
                                            <li>
                                                <span>Size hộp</span>
                                                <div><?= $data['Size'] ?></div>
                            ...
                            <?php } ?>
                            <div class="<?php if ($data['MaDM'] != null) {
